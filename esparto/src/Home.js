 ...
 export default function Home() 
 {
    ...
    return ( 
        <div className="Home">
            ...
            <h6>A digital platform for Art Gallery is here.</h6>
            <p>We can also have a major look in detail with the Artist Name, 
         ...
         <p>An artist is a person engaged in an activity related to creating 
            ...
            and mostly restricted to contexts such as critics' reviews.</p>
        </div>
        );
} 